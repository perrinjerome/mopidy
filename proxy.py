...
class ProxyServer(protocol.Protocol):
    def connectionMade(self):
        ...
        #reactor.connectTCP("192.168.1.85", 6602, factory)
        #reactor.connectTCP("192.168.1.40", 6600, factory)
        reactor.connectTCP("192.168.1.85", 6601, factory)
...
if __name__ == "__main__":
    ...
    reactor.listenTCP(6600, factory, interface="0.0.0.0")
    reactor.run()
